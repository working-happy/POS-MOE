...
class Data:
    def __init__(self):
        ...
        self.object_emb_dir = './data/embedding/glove.twitter.27B.200d.txt'
        self.log_dir = None
    ...
    def build_pretrain_emb(self):
        ...
        self.pretrain_object_embedding, self.object_emb_dim = build_pretrain_embedding(self.object_emb_dir, self.object_alphabet, self.object_emb_dim, self.norm_object_emb)
            # pretrain_object_embedding   (94,200)

    def generate_instance(self):
        self.train_texts, self.train_Ids = read_instance(object_file=self.object_dir, object_alphabet=self.object_alphabet)
